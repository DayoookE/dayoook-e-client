...
export default function TutorList({
        ...
        try {
            ...
            if (isRecommend) {
                ...
                const params = new URLSearchParams([
                    ...(ageOptions.length > 0 ? ageOptions.map(id => ['ageGroupId', id.toString()]) : []),
                    ...(languageOptions.length > 0 ? languageOptions.map(id => ['languageId', id.toString()]) : []),
                ...
                setTutors((prev) => ((page === 1 || page === 0) ? newTutors : [...prev, ...newTutors]))
    ...
    useEffect(() => {
        setTutors([])
        console.log(`Age options: ${ageOptions}, language options: ${languageOptions}`)
        if (page === 0) {
            setPage(1);
        } else {
            setPage(0);
    ...
    return (
        <s.TutorListContentContainer>
            <TutorSelect isRecommend={isRecommend} setIsRecommend={setIsRecommend}
                         setLanguageOptions={setLanguageOptions} setAgeOptions={setAgeOptions}/>
            <s.Cards>
